...
public class EnemyShot : MonoBehaviour
{
    ...
    void Start()
    {
        //On le fait spawn les offsets car il y avait des collisions avec l'ennemi (corrigé maintenant)
    ...
    void InstanceBullet()
    {
        //Distance mini pour que l'enneemi tir pour éviter les snipers
